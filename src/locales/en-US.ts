export default {
  ...
  home: {
    ...
    sudoPassword: {
      ...
      description:
        'To carry all traffic through the VPN, the computer has to create a network channel, and that only happens with administrator rights. The password is kept encrypted on this computer and is never sent anywhere.',
      placeholder: 'Enter the administrator password',
      save: 'Save & continue',
      saved: 'Password saved',
      required: 'To carry all traffic through the VPN, the administrator password is required',
      invalid: 'The password did not fit, please try again',
    ...
    deviceNews: {
      ...
      trial: 'The free period has started — you can connect',
      over: 'The subscription has ended, that is why the connection dropped',
      pay: 'Renew in the bot',
      ok: 'Got it',
    },
    subscription: {
      activeUntil: 'Subscription until {date}',
      trialUntil: 'Free period until {date}',
    ...
    error: {
      ...
      whatToDo: 'What to do',
      steps: {
        checkKey: 'Check the key — refresh it on the Key screen',
        restart: 'Restart the connection with the button below',
        support: 'Write to support — we answer in the bot',
      },
      goToKey: 'Open the Key screen',
      ...
      kinds: {
        ...
        conflict_cleanup_failed:
          'The previous connection did not come down — enter the administrator password in the settings and try again. If that does not help, restart the computer',
  ...
  setting: {
    ...
    kernel: {
      ...
      stages: {
        ...
        download: 'Downloading the kernel file',
        extract: 'Unpacking the kernel file',
        done: 'The kernel is downloaded',
        failed: 'The kernel could not be downloaded',
      },
  ...
  key: {
    ...
    fromBot: {
      ...
      failed: 'The bot did not answer. Check the connection and try again',
    },
    guest: {
      name: 'Trial access',
      title: 'Try it without signing up',
      text: 'The connection turns on for {hours} h with {traffic} GB of traffic. No Telegram and no payment — enough to open the bot and pay for a subscription.',
      take: 'Try for free',
    ...
    current: {
      ...
      refresh: 'Refresh',
      staleTitle: 'Has the key stopped working?',
      staleText:
        'Press “Refresh” and the key arrives again. If the connection still does not turn on, the subscription has ended: renew it in the bot and the key starts working on its own.',
    },
  },
  tray: {
    kernel: 'Kernel',
  ...
  notification: {
    ...
    systemProxyEnabled: 'Regular mode is on',
    tunEnabled: 'All traffic now goes through the VPN',
