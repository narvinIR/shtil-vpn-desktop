...
export default {
  ...
  key: {
    ...
    guest: {
      ...
      alreadyIssued: 'Dieser Computer hat den Testzugang bereits genutzt. Den Schlüssel gibt der Shtil-Bot in Telegram',
      limit: 'Für heute sind keine Testzugänge mehr frei. Versuchen Sie es später oder holen Sie den Schlüssel im Bot',
      disabled: 'Der Testzugang ist gerade geschlossen. Den Schlüssel gibt der Shtil-Bot in Telegram',
      failed: 'Der Server hat nicht geantwortet. Prüfen Sie die Verbindung und versuchen Sie es erneut',
    },
    link: {
