export default {
  ...
  key: {
    ...
    fromBot: {
      ...
      title: 'Ключ из бота',
      text: 'Ключ выдаёт бот «Штиль» в Telegram — там же оплата и срок подписки. Откройте бота, скопируйте ссылку из раздела «Мой VPN» и вставьте её в поле ниже.',
      open: 'Открыть бота',
      soon: 'Скоро ключ будет приезжать по коду — вставлять ссылку не придётся',
    },
    link: {
