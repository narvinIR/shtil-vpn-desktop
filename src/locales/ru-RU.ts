export default {
  ...
  key: {
    ...
    fromBot: {
      ...
      open: 'Открыть бота',
      getCode: 'Получить ключ по коду',
      getCodeHint: 'Приложение покажет код, вы назовёте его боту — ключ приедет сам',
      codeText: 'Отправьте этот код боту «Штиль» — ключ приедет сюда сам',
