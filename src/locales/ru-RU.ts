export default {
  ...
  key: {
    ...
    fromBot: {
      title: 'Ключ из бота',
      text: 'Ключ выдаёт бот «Штиль» в Telegram — там же оплата и срок подписки. Откройте бота, скопируйте ссылку из раздела «Мой VPN» и вставьте её ниже — в «У меня уже есть ссылка».',
      open: 'Открыть бота',
      soon: 'Скоро ключ будет приезжать по коду — вставлять ссылку не придётся',
    },
    link: {
      title: 'У меня уже есть ссылка',
      placeholder: 'https://sub.ndvsdom54.ru/sub/…',
      namePlaceholder: 'Название — например, «Штиль»',
      apply: 'Применить ключ',
      needLink: 'Вставьте ссылку',
    },
    file: {
