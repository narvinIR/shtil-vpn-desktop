...
const DEFAULT_SINGBOX_DNS_PROXY = 'https://dns.google/dns-query'
const DEFAULT_SINGBOX_DNS_CN = 'https://dns.yandex.ru/dns-query'
const DEFAULT_SINGBOX_DNS_RESOLVER = '77.88.8.8'
