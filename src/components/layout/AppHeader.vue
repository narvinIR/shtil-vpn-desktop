...
.brand-logo {
  ...
  height: 26px;
  object-fit: contain;
  /* Скругления здесь нет намеренно. Прежний комментарий уверял, что «знак
     нарисован плитой во весь квадрат», — сам файл это опровергает: в
     `assets/icon.png` все четыре угла полностью прозрачны, своя непрерывная
     кривая начинается на 29,7 % от края. Круговые 7 точек поверх неё срезали
     1,5 % непрозрачных точек. Знак в шапке и на вкладке «О программе» — один
     знак: и форма, и тень берутся одинаково. */
