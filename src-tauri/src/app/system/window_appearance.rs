...
pub fn apply(window: &WebviewWindow) {
    ...
    // стол за окном виден, а текст читается.
    //
    // Материал остаётся один на обе темы. Пробовали переключать его вместе с
    // темой (15.08.2026): светлее не стало вовсе — замер до правки давал
    // рабочую область 173 при карточках 224, после правки 177 при 225. Светлую
    // тему вытянул её собственный фон в палитре, а не материал системы.
